...
Secretaria de Inspeção do Trabalho: Trabalho Escravo segue a LGPD (Lei nº 13.709/2018).
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [sit_trabalho_escravo@mcp.ai](mailto:sit_trabalho_escravo@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
